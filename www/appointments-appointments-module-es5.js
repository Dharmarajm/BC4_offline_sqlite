...
var AddAppointmentPage = /** @class */ (function () {
    function AddAppointmentPage(toast, alertController, localNotifications, router, fb, route, service, datepipe, statusBar, database, databaseSummary) {
        this.toast = toast;
    ...
    AddAppointmentPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        // })
        this.databaseSummary.getEnumMasters('appointment').then(function (res) {
            _this.dropdown = res['enum_masters'];
        })
            .catch(function (error) { console.log(error); });
    };
    Object.defineProperty(AddAppointmentPage.prototype, "f", {
        get: function () { return this.addform.controls; },
        enumerable: true,
        configurable: true
    });
    AddAppointmentPage.prototype.ionViewWillEnter = function () {
    ...
    AddAppointmentPage.prototype.addDetails = function (val) {
        this.submitted = true;
    ...
    AddAppointmentPage.prototype.ConfirmEvent = function (val) {
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function () {
                                            ...
                                            //   console.log("error")
                                            // })
                                            _this.database.createAnEvent(app_data).then(function (res) {
                                                var getEventId = res['event_id'];
                                                if (val.reminder == true) {
                                                    var uniqueTime = new Date().getDate() + new Date().getMonth() + new Date().getFullYear() + new Date().getHours() + new Date().getMinutes() + new Date().getSeconds() + new Date().getMilliseconds();
                                                    var getDate = new Date(val.event_datetime);
                                                    var getTime = new Date(val.event_time);
                                                    var getHours = getTime.getHours();
                                                    var getMinutes_1 = getTime.getMinutes();
                                                    var getSeconds = getTime.getSeconds();
                                                    var getMilliseconds = getTime.getMilliseconds();
                                                    getDate.setHours(getHours, getMinutes_1, getSeconds, getMilliseconds);
                                                    var ID = getEventId;
                                                    console.log(ID);
                                                    ...
                                                    _this.scheduleNotifications(repeatAlarmValue);
                                                }
                                                else {
                                                    _this.Progress = false;
                                                    _this.router.navigate(["self-care-tabs/tabs/tab1/appointments"]);
                                                }
                                            })
                                                .catch(function (error) { console.log(error); });
                                        }
    ...
    AddAppointmentPage.prototype.warning = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
    ...
    AddAppointmentPage.prototype.scheduleNotifications = function (data) {
        this.localNotifications.schedule(data);
        this.Progress = false;
        this.router.navigate(["self-care-tabs/tabs/tab1/appointments"]);
    };
    AddAppointmentPage.prototype.ionViewWillLeave = function () {
        this.statusBar.backgroundColorByHexString('#c7a254');
        this.tabBar.style.display = 'flex';
    };
    AddAppointmentPage.ctorParameters = function () { return [
...
var AppointmentsPage = /** @class */ (function () {
    function AppointmentsPage(toast, alertController, toastController, router, route, service, datepipe, statusBar, databaseSummary, database) {
        var _this = this;
        this.toast = toast;
        this.alertController = alertController;
    ...
    AppointmentsPage.prototype.upcoming = function () {
        var _this = this;
    ...
    AppointmentsPage.prototype.Completed = function () {
        var _this = this;
    ...
    AppointmentsPage.prototype.segmentChanged = function (event) {
        console.log(event);
        this.selectedSegment = event;
        //this.ionViewWillEnter();
    };
    AppointmentsPage.prototype.addPage = function () {
        this.router.navigate(["self-care-tabs/tabs/tab1/appointments/add-appointment"]);
    };
    AppointmentsPage.prototype.groupBy = function (data) {
        var _this = this;
        ...
        var valueOther = [];
        var valueCurrent = [];
        var example = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(records).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["groupBy"])(function (person) { return Object(_angular_common__WEBPACK_IMPORTED_MODULE_4__["formatDate"])(person.event_datetime, 'yyyy-MM-dd', 'en-US'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (group) { return group.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["toArray"])()); })).subscribe(function (val) {
            console.log(val);
            if (val) {
    ...
    AppointmentsPage.prototype.deleteItem = function (id, show) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AppointmentsPage.prototype.presentToast = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AppointmentsPage.prototype.SearchItem = function (event) {
        var _this = this;
    ...
    AppointmentsPage.prototype.editDetails = function (view) {
    ...
    AppointmentsPage.prototype.loadData = function (event) {
        var _this = this;
        setTimeout(function () {
            console.log('Done');
            _this.per_page += 1;
    ...
    AppointmentsPage.prototype.ionViewWillLeave = function () {
        this.statusBar.backgroundColorByHexString('#483df6');
        this.tabBar.classList.add("tab-selected");
    };
    AppointmentsPage.prototype.completedSearchItem = function (event) {
        var _this = this;
        var search = event.detail.value;
        console.log(event);
        this.completepage = 1;
    ...
    AppointmentsPage.ctorParameters = function () { return [
        { type: _ionic_native_toast_ngx__WEBPACK_IMPORTED_MODULE_9__["Toast"] },
...
var EditAppointmentPage = /** @class */ (function () {
    function EditAppointmentPage(localNotifications, alertController, toastController, router, route, service, datepipe, fb, statusBar, database, databaseSummary) {
        var _this = this;
        this.localNotifications = localNotifications;
        this.alertController = alertController;
        this.toastController = toastController;
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            if (params && params.viewAppointment) {
                _this.data = JSON.parse(params.viewAppointment);
                _this.getRoute = params.check;
                console.log(_this.data);
                if (_this.getRoute == 'home') {
                    _this.reminder = _this.data['event_options']['reminder'];
                    _this.fixed_appointment = _this.data['event_options']['appointment_fixed'];
                }
                else {
                    _this.reminder = _this.data['reminder'];
                    _this.fixed_appointment = _this.data['appointment_fixed'];
                }
    ...
    EditAppointmentPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.todaydate = new Date().toISOString();
    ...
    Object.defineProperty(EditAppointmentPage.prototype, "f", {
        get: function () { return this.editform.controls; },
        enumerable: true,
        configurable: true
    });
    EditAppointmentPage.prototype.cancel = function () {
    ...
    EditAppointmentPage.prototype.editDetails = function (val) {
        this.submitted = true;
    ...
    EditAppointmentPage.prototype.ConfirmEvent = function (val) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        var app_data = {
                                            ...
                                            "event_type": "appointment",
                                            "created_at": _this.data['created_at']
                                        };
                                        // this.service.EditDetails(this.data['id'],app_data).subscribe(res=>{
                                        //   let getEventId:any=this.data['id'];
                                        //   if(val.reminder==true && this.reminder==false || val.reminder==true && this.reminder==true){
                                        ...
                                        //   console.log("error");
                                        // })
                                        _this.database.updateAnEvent(_this.data['event_id'], app_data).then(function (res) {
                                            var getEventId = _this.data['event_id'];
                                            if (val.reminder == true && _this.reminder == false || val.reminder == true && _this.reminder == true) {
                                                _this.assignOrCancelNotifications(val, getEventId, 'assign');
                                            }
                                            else if (val.reminder == false && _this.reminder == true) {
                                                _this.assignOrCancelNotifications(val, getEventId, 'cancel');
                                            }
                                            else {
                                                _this.Progress = false;
                                                if (_this.getRoute == 'home') {
                                                    _this.router.navigate(["self-care-tabs/tabs/tab1"]);
                                                }
                                                else {
                                                    _this.router.navigate(["self-care-tabs/tabs/tab1/appointments"]);
                                                }
    ...
    EditAppointmentPage.prototype.warning = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    EditAppointmentPage.prototype.assignOrCancelNotifications = function (val, getEventId, notify) {
        var _this = this;
        var ID = getEventId;
        if (notify == 'assign') {
            var getDate = new Date(val.event_datetime);
            ...
            this.localNotifications.cancel(ID).then(function (res) {
                console.log(res);
                _this.Progress = false;
                if (_this.getRoute == 'home') {
                    _this.router.navigate(["self-care-tabs/tabs/tab1"]);
    ...
    EditAppointmentPage.prototype.scheduleNotifications = function (data) {
        this.localNotifications.schedule(data);
        this.Progress = false;
        if (this.getRoute == 'home') {
            this.router.navigate(["self-care-tabs/tabs/tab1"]);
    ...
    EditAppointmentPage.prototype.ionViewWillLeave = function () {
        this.statusBar.backgroundColorByHexString('#c7a254');
        this.tabBar.style.display = 'flex';
    };
    EditAppointmentPage.ctorParameters = function () { return [
        { type: _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_8__["LocalNotifications"] },
