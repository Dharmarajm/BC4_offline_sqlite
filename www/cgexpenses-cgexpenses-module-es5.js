...
var CgExpenseFiltersPage = /** @class */ (function () {
    function CgExpenseFiltersPage(datepipe, modalController, fb, serv, router, statusBar) {
...
var CgExpenseAnalyticsPage = /** @class */ (function () {
    function CgExpenseAnalyticsPage(modalController, service, datepipe, statusBar) {
        this.modalController = modalController;
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            if (data['data'] != undefined) {
                                ...
                                _this.service.filterChart(data['data']).subscribe(function (res) {
                                    _this.chartres = res;
    ...
    CgExpenseAnalyticsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_7__["ModalController"], _care_giver_service_caregiver_service_service__WEBPACK_IMPORTED_MODULE_2__["careGiverService"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_9__["StatusBar"]])
...
var CgExpenseviewSummaryPage = /** @class */ (function () {
    function CgExpenseviewSummaryPage(toast, modalCtrl, toastController, alertController, service, statusBar) {
        this.toast = toast;
    ...
    CgExpenseviewSummaryPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.user_id = localStorage.getItem("user_id");
        this.service.view_expenses(this.user_id).subscribe(function (res) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.service.filterAmount(from_date, end_date, this.user_id).subscribe(function (res) {
                            console.log(res);
                            _this.view_all_expen = res;
                            _this.expen_key = Object.keys(_this.view_all_expen.expense);
                            _this.getChartValue = _this.expen_key.map(function (res) {
...
var CgexpensesPageModule = /** @class */ (function () {
    ...
    CgexpensesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"], _ionic_native_toast_ngx__WEBPACK_IMPORTED_MODULE_11__["Toast"]]
        })
