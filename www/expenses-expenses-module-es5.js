...
var viewSummaryPage = /** @class */ (function () {
    function viewSummaryPage(toast, modalCtrl, toastController, alertController, expen_view, statusBar, database) {
        this.toast = toast;
