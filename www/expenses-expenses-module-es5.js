...
var addExpensesPage = /** @class */ (function () {
    function addExpensesPage(alertController, toast, toastController, router, event, fb, statusBar) {
    ...
    addExpensesPage.prototype.ngOnInit = function () {
        ...
        this.event.event_add_option().subscribe(function (res) {
                        ...
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function () {
                                            _this.Progress = true;
                                            _this.event.event_add(_this.myForm.value).subscribe(function (res) {
...
var ExpensesPageModule = /** @class */ (function () {
    ...
    ExpensesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"], _ionic_native_toast_ngx__WEBPACK_IMPORTED_MODULE_13__["Toast"]]
        })
    ], ExpensesPageModule);
...
var ExpensesPage = /** @class */ (function () {
    function ExpensesPage(expense, datepipe, statusBar) {
    ...
    ExpensesPage.prototype.ionViewWillEnter = function () {
        ...
        this.expense.main_chart(this.user_id).subscribe(function (res) {
            ...
            console.log(_this.main_chart.Lastmonth, _this.main_chart.Currentmonth, _this.main_chart.Year, 'len');
    ...
    ExpensesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_self_common_service_settings_settings_service__WEBPACK_IMPORTED_MODULE_2__["settingsService"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"]])
    ], ExpensesPage);
    return ExpensesPage;
}());
...
var FiltersPage = /** @class */ (function () {
    function FiltersPage(datepipe, modalController, fb, serv, router, statusBar) {
        this.datepipe = datepipe;
    ...
    FiltersPage.prototype.ngOnInit = function () {
        ...
        this.filter = this.fb.group({
            'from_date': [this.todaydate, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            'end_date': [this.todaydate, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            'event_name': ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]]
        });
        this.user_id = localStorage.getItem("user_id");
        this.serv.chartrepeat(this.user_id).subscribe(function (res) {
    ...
    FiltersPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ModalController"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _self_common_service_settings_settings_service__WEBPACK_IMPORTED_MODULE_3__["settingsService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_7__["StatusBar"]])
    ], FiltersPage);
    return FiltersPage;
}());
...
var viewAnalyticsPage = /** @class */ (function () {
    function viewAnalyticsPage(modalController, service, datepipe, statusBar) {
        this.modalController = modalController;
    ...
    viewAnalyticsPage.prototype.ionViewWillEnter = function () {
        ...
        this.tabBar.style.display = 'none';
        this.user_id = localStorage.getItem("user_id");
        this.service.chartrepeat(this.user_id).subscribe(function (res) {
            _this.chartres = res;
            console.log(_this.chartres, 'chart');
            _this.chart_keys = Object.keys(_this.chartres);
            setTimeout(function () {
                _this.loader = false;
            }, 1500);
            setTimeout(function () {
                for (var _i = 0, _a = _this.chart_keys; _i < _a.length; _i++) {
                    var i = _a[_i];
                    _this.charts(i, _this.chartres[i]);
                }
            }, 2000);
        });
    };
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            if (data['data'] != undefined) {
                                ...
                                _this.service.filterChart(_this.user_id, data['data']).subscribe(function (res) {
                                    _this.chartres = res;
    ...
    viewAnalyticsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_7__["ModalController"], _self_common_service_settings_settings_service__WEBPACK_IMPORTED_MODULE_2__["settingsService"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_9__["StatusBar"]])
    ], viewAnalyticsPage);
...
var viewSummaryPage = /** @class */ (function () {
    function viewSummaryPage(toast, modalCtrl, toastController, alertController, expen_view, statusBar) {
        this.toast = toast;
    ...
    viewSummaryPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.user_id = localStorage.getItem("user_id");
        this.expen_view.view_expenses(this.user_id).subscribe(function (res) {
                                ...
                                buttons: [
                                    {
                                        text: 'Confirm',
                                        handler: function () {
                                            _this.expen_view.event_view_delete(id).subscribe(function (res) {
                                                console.log(res);
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.expen_view.filterAmount(from_date, end_date, this.user_id).subscribe(function (res) {
                            console.log(res);
                            _this.view_all_expen = res;
                            _this.expen_key = Object.keys(_this.view_all_expen.expense);
                            _this.getChartValue = _this.expen_key.map(function (res) {
