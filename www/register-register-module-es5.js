...
var UsermanagementService = /** @class */ (function () {
    ...
    UsermanagementService.prototype.care_detail = function (data) {
        return this.http.post("users/patient_register", data);
    };
    UsermanagementService.prototype.login_credential = function (credential) {
        return this.http.post("auth/login", credential);
    };
    UsermanagementService.prototype.verify_CGId = function (id) {
        return this.http.get("users/user_uid?user_uid=" + id);
    };
    UsermanagementService.prototype.CGdetails = function (val) {
        return this.http.post("users/caregiver_register", val);
    };
    UsermanagementService.prototype.emailVerify = function (mail) {
        return this.http.get("users/identify_user?email=" + mail);
    };
    UsermanagementService.prototype.VerifyCode = function (code, id) {
        return this.http.get("users/verification_code?user_id=" + id + "&&verification_code=" + code);
    };
    UsermanagementService.prototype.pwdUpdate = function (val) {
        return this.http.post("users/password_updation", val);
    };
    UsermanagementService.prototype.subscriptionAmt = function () {
        return this.http.get("subscriptions/app_amount");
    };
    UsermanagementService.prototype.offerAmt = function () {
        return this.http.get("offers");
    };
    UsermanagementService.prototype.couponAmt = function (user_id, id) {
        return this.http.get("subscriptions/apply_coupon?user_id=" + user_id + "&&offer_id=" + id);
    };
    UsermanagementService.prototype.selfPayment = function (data) {
        return this.http.post("subscriptions/make_payment", data);
    };
    UsermanagementService.prototype.user_data = function (e_id) {
...
var careGiverRegisterPage = /** @class */ (function () {
    function careGiverRegisterPage(toast, modalController, fb, router, user_service, translate, navCtrl) {
        this.toast = toast;
    ...
    careGiverRegisterPage.prototype.ionViewDidEnter = function () {
        this.unique_identification.setFocus();
    };
    careGiverRegisterPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.giverForm.controls['user_uid'].valueChanges.subscribe(function (val) {
            _this.id = val;
        });
    };
    Object.defineProperty(careGiverRegisterPage.prototype, "f", {
        get: function () { return this.giverForm.controls; },
        enumerable: true,
        configurable: true
    });
    careGiverRegisterPage.prototype.care_giverId = function () {
        var _this = this;
        this.user_service.verify_CGId(this.id).subscribe(function (res) {
            var value = res["message"];
            if (value == 'false') {
                _this.presentToast('Enter valid UID');
            }
        }, function (error) {
            if (error.status == 401) {
                _this.presentToast('Enter valid UID');
    ...
    careGiverRegisterPage.prototype.CareGiverDetail = function (giver_detail) {
        var _this = this;
        console.log(giver_detail);
        this.submitted = true;
        if (this.giverForm.valid) {
            this.registerProgress = true;
            var data = giver_detail['email'].toLowerCase();
            var value = { 'email': data, 'user_uid': giver_detail['user_uid'], 'name': giver_detail['name'], 'mobile_no': giver_detail['mobile_no'], 'password': giver_detail['password'], 'role_id': 2, };
            this.user_service.CGdetails(value).subscribe(function (res) {
                _this.registerProgress = false;
                _this.presentToast('You have registered successfully');
                _this.router.navigate(['/login']);
            }, function (error) {
                _this.registerProgress = false;
                if (error.status == 401) {
                    _this.presentToast('UID not valid');
                }
                console.log(error);
            });
        }
    ...
    careGiverRegisterPage.prototype._keyPress = function (event) {
        var pattern = /[0-9]/;
    ...
    careGiverRegisterPage.prototype.presentToast = function (message) {
    ...
    careGiverRegisterPage.prototype.equalto = function (field_name) {
    ...
    careGiverRegisterPage.prototype.goToterms = function () {
        this.router.navigate(['/terms_conditions']);
    };
    careGiverRegisterPage.ctorParameters = function () { return [
...
var OffersPage = /** @class */ (function () {
    function OffersPage(modalController, user_service) {
        var _this = this;
        this.modalController = modalController;
        this.user_service = user_service;
        this.user_service.offerAmt().subscribe(function (res) {
            _this.offer_list = res['offers'];
            console.log(_this.offer_list);
        });
    }
    OffersPage.prototype.ngOnInit = function () {
    };
    OffersPage.prototype.select = function (offer) {
        var _this = this;
        this.user_profile = JSON.parse(localStorage.getItem("userdata"));
        this.prefill = this.user_profile['patient']['id'];
        this.user_service.couponAmt(this.prefill, offer['id']).subscribe(function (res) {
            console.log(res);
            var data = res;
            _this.value = offer;
            _this.value['amount'] = data['amount'];
            console.log(_this.value);
            _this.modalController.dismiss(_this.value);
        });
    };
    OffersPage.prototype.close = function () {
...
var paymentSuccessPage = /** @class */ (function () {
    function paymentSuccessPage(router) {
        this.router = router;
    }
    paymentSuccessPage.prototype.ngOnInit = function () {
    };
    paymentSuccessPage.prototype.Login = function () {
        this.router.navigate(['login']);
    };
    paymentSuccessPage.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var selfCareOfferPaymentPage = /** @class */ (function () {
    function selfCareOfferPaymentPage(router, modalController, user_service) {
        var _this = this;
        this.router = router;
        this.modalController = modalController;
        this.user_service = user_service;
        ...
        this.user_service.user_data(this.prefill.email).subscribe(function (res) {
            console.log(res);
            var data = res['authentication'][0];
            var dataAuth = {
                patient: data
            };
            localStorage.setItem("userdata", JSON.stringify(dataAuth));
            _this.user_profile = JSON.parse(localStorage.getItem("userdata"));
            _this.prefill = _this.user_profile['patient'];
        });
        this.user_service.subscriptionAmt().subscribe(function (res) {
            _this.pay_amount = res;
            console.log(_this.pay_amount);
        });
    }
    selfCareOfferPaymentPage.prototype.payment = function () {
        var _this = this;
    ...
    selfCareOfferPaymentPage.prototype.makePayment = function (payment) {
        var _this = this;
        ...
        this.user_service.selfPayment(data).subscribe(function (res) {
            console.log(_this.pay_amount);
            _this.router.navigate(['register/payment-success']);
        }, function (error) {
            alert('Failed to update your payment,Please contact administrator');
        });
    };
    selfCareOfferPaymentPage.prototype.coupon = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (offerData != 'data') {
                                _this.status = true;
                                _this.offer_details = offerData;
                                console.log(_this.offer_details);
                            }
                        });
    ...
    selfCareOfferPaymentPage.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    ...
    return selfCareOfferPaymentPage;
}());
...
var selfCarePaymentPage = /** @class */ (function () {
    function selfCarePaymentPage(router, modalController) {
        this.router = router;
        this.modalController = modalController;
    ...
    selfCarePaymentPage.prototype.payment = function () {
        this.router.navigate(['register/payment-success']);
        /*this.navCtrl.navigateBack('/final-registration');*/
        // var options = {
        //     key: this.razor_key,
    ...
    selfCarePaymentPage.prototype.coupon = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    selfCarePaymentPage.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] }
    ]; };
...
var selfCareRegisterPage = /** @class */ (function () {
    function selfCareRegisterPage(toast, translate, modalController, router, fb, user_service, toastController) {
        this.toast = toast;
        this.translate = translate;
        this.modalController = modalController;
        this.router = router;
    ...
    selfCareRegisterPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(selfCareRegisterPage.prototype, "f", {
        get: function () { return this.detailForm.controls; },
        enumerable: true,
        configurable: true
    });
    selfCareRegisterPage.prototype.ionViewDidEnter = function () {
        this.name_focus.setFocus();
    };
    selfCareRegisterPage.prototype.self_detail = function (detail) {
        var _this = this;
        this.submitted = true;
        if (this.detailForm.valid) {
            this.registerProgress = true;
            var id = detail['email'].toLowerCase();
            var data = {
                "user": {
                    'name': detail.name,
                    'email': id,
            ...
            this.user_service.care_detail(data).subscribe(function (res) {
                _this.registerProgress = false;
                var user_details = res;
                localStorage.setItem("userdata", JSON.stringify(user_details));
                _this.presentToast('You have registered successfully');
                _this.router.navigate(['register/self-care-offer-payment']);
            }, function (error) {
                _this.registerProgress = false;
                _this.presentToast(error["error"]["error"]);
            });
        }
    ...
    selfCareRegisterPage.prototype.equalto = function (field_name) {
        return function (control) {
            var input = control.value;
            var isValid = control.root.value[field_name] == input;
            if (!isValid) {
    ...
    selfCareRegisterPage.prototype._keyPress = function (event) {
        var pattern = /[0-9]/;
        var inputChar = String.fromCharCode(event.charCode);
        if (event.charCode != 0) {
            if (!pattern.test(inputChar)) {
    ...
    selfCareRegisterPage.prototype.presentToast = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.toast.show(message, '2000', 'bottom').subscribe(function (toast) {
                    console.log(toast);
    ...
    selfCareRegisterPage.prototype.goToterms = function () {
        this.router.navigate(['/terms_conditions']);
    };
    selfCareRegisterPage.ctorParameters = function () { return [
        { type: _ionic_native_toast_ngx__WEBPACK_IMPORTED_MODULE_7__["Toast"] },
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateService"] },
