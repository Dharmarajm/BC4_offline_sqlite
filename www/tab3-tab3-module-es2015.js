...
let Tab3Page = class Tab3Page {
    constructor(toast, toastController, localNotifications, file, FilePath, fileChooser, statusBar, modalController, sanitizer, serv, actionSheetController, router, alertController, clipboard, database) {
        this.toast = toast;
        this.toastController = toastController;
