...
var AddOthersPage = /** @class */ (function () {
    function AddOthersPage(platform, toast, localNotifications, alertController, datepipe, service, fb, route, router, statusBar) {
    ...
    AddOthersPage.prototype.validateBeforeSubmit = function (form) {
        ...
        if (this.other_alert_form.invalid) {
            ...
            var date = this.datepipe.transform(form.event_datetime, "dd MMM yyyy");
            var data = {
                        ...
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function () {
                                            _this.Progress = true;
                                            _this.service.commonPost(data).subscribe(function (res) {
                                                var getData = res;
                                                var getEventId = res['event']['id'];
...
var AddMedicationPage = /** @class */ (function () {
    function AddMedicationPage(camera, actionSheetController, toast, localNotifications, file, fb, transfer, imagePicker, webview, sanitizer, alertController, router, route, service, datepipe, statusBar) {
        this.camera = camera;
    ...
    AddMedicationPage.prototype.valueSet = function (data) {
        ...
        if (data.detail.value == "Tablet") {
            ...
            var validators = [_angular_forms__WEBPACK_IMPORTED_MODULE_13__["Validators"].required];
    ...
    AddMedicationPage.prototype.addDeatils = function (val) {
        ...
        if (this.store_photos.length == 0) {
            ...
            var date = this.datepipe.transform(val.event_datetime, "dd MMM yyyy");
            var medi_details = {
                        ...
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function () {
                                            _this.Progress = true;
                                            _this.service.commonPost(medi_details).subscribe(function (res) {
                                                var getData = res;
                                                _this.getEventId = res['event']['id'];
                                                _this.assignSchedule(val);
                                            });
                                        }
                                    }
                                ]
    ...
    AddMedicationPage.prototype.assignSchedule = function (val) {
        var _this = this;
        var repeatAlarmValue = [];
    ...
    //}
    AddMedicationPage.prototype.sample = function (event_id) {
        var _this = this;
        ...
        for (var i = 0; i < this.fileuri.length; i++) {
            ...
            fileTransfer.upload(this.fileuri[i].uri, _environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].apiUrl + 'events/update_image', options).then(function (res) {
                console.log(i);
                console.log(_this.fileuri.length - i);
                console.log(_this.fileuri.length);
                if (_this.fileuri.length - i == 0) {
                    _this.Progress = false;
                    _this.presentToast('Medication added successfully');
...
var AddVitalsAlertPage = /** @class */ (function () {
    function AddVitalsAlertPage(toast, localNotifications, alertController, datepipe, service, fb, route, router, statusBar) {
        this.toast = toast;
        this.localNotifications = localNotifications;
        this.alertController = alertController;
        this.datepipe = datepipe;
    ...
    AddVitalsAlertPage.prototype.ionViewWillEnter = function () {
        ...
        this.service.vitalReading().subscribe(function (res) {
...
var AlertPage = /** @class */ (function () {
    ...
    function AlertPage(alertController, toastController, router, route, settingService, datepipe, statusBar) {
        var _this = this;
        this.alertController = alertController;
                            ...
                            buttons: [
                                {
                                    text: 'Confirm',
                                    handler: function () {
                                        _this.settingService.commonDeleteEvent(id).subscribe(function (res) {
                                            console.log(res);
...
var EditOthersPage = /** @class */ (function () {
    function EditOthersPage(toast, localNotifications, alertController, toastController, datepipe, service, fb, route, router, statusBar) {
        var _this = this;
        this.toast = toast;
        this.localNotifications = localNotifications;
        this.alertController = alertController;
                        ...
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function () {
                                            _this.Progress = true;
                                            _this.service.commonUpdatePost(_this.getAllDatas['id'], data).subscribe(function (res) {
                                                var getData = res;
                                                var getEventId = _this.getAllDatas['id'];
...
var EditMedicationPage = /** @class */ (function () {
    function EditMedicationPage(toast, camera, actionSheetController, localNotifications, alertController, toastController, router, route, service, datepipe, file, fb, transfer, imagePicker, webview, sanitizer, statusBar) {
        var _this = this;
        this.toast = toast;
        this.camera = camera;
        this.actionSheetController = actionSheetController;
    ...
    EditMedicationPage.prototype.ionViewWillEnter = function () {
        ...
        this.fileuri = [];
        this.spliceIndexArray = [];
        var assets = this.edit_details.event_assets;
        console.log(this.edit_all_image);
        for (var i in assets) {
            var mapUrl = this.environment + assets[i]["url"];
                        ...
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function () {
                                            _this.Progress = true;
                                            _this.service.commonUpdatePost(_this.edit_details['id'], medi_details).subscribe(function (res) {
                                                var getData = res;
                                                _this.getEventId = _this.edit_details['id'];
                                                if (_this.NotifyRepeat == true && _this.repeatValue.length < _this.Originalvalue.length) {
                                                    var cancelArray = [];
                                                    for (var i in _this.Originalvalue) {
                                                        if (+i > _this.repeatValue.length - 1) {
                                                    ...
                                                    _this.assignOrCancelNotifications(cancelArray, val, _this.getEventId);
                                                }
                                                else {
                                                    _this.assignSchedule(val);
                                                }
    ...
    EditMedicationPage.prototype.assignSchedule = function (val) {
        var _this = this;
        var repeatAlarmValue = [];
        var getDate = new Date(val.event_datetime);
        var getTime = new Date(val.event_time);
        ...
        if (val.remainder_repeat == true) {
            if (val.event_category == 'days') {
                ...
                if (this.spliceIndexArray.length > 0) {
                    ...
                    var event_id = this.edit_details['id'];
    ...
    EditMedicationPage.prototype.scheduleNotifications = function (data, getEventId) {
        if (data != 'test') {
            this.localNotifications.schedule(data);
        }
        if (this.spliceIndexArray.length > 0) {
    ...
    EditMedicationPage.prototype.assignOrCancelNotifications = function (cancelArray, val, getEventId) {
        var _this = this;
        this.localNotifications.cancel(cancelArray).then(function (res) {
            console.log(res);
            _this.assignSchedule(val);
    ...
    EditMedicationPage.prototype.sample = function (event_id) {
        var _this = this;
        var fileTransfer = this.transfer.create();
        var data = { id: event_id };
        for (var i = 0; i < this.fileuri.length; i++) {
            ...
            fileTransfer.upload(this.fileuri[i].uri, _environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].apiUrl + 'events/update_image', options).then(function (res) {
                if (_this.fileuri.length - i == 0) {
                    _this.Progress = false;
    ...
    EditMedicationPage.prototype.selectimage = function () {
        ...
        this.imagePicker.getPictures(options).then(function (results) {
            for (var i = 0; i < results.length; i++) {
                console.log('Image URI: ' + results[i]);
                _this.edit_all_image.push({ "uri": _this.webview.convertFileSrc(results[i]) });
    ...
    EditMedicationPage.prototype.takePicture = function () {
        ...
        this.camera.getPicture(options).then(function (imageData) {
            // imageData is either a base64 encoded string or a file URI
            // If it's base64 (DATA_URL):
            _this.edit_all_image.push({ "uri": _this.webview.convertFileSrc(imageData) });
            console.log(_this.edit_all_image, 'webviewuri');
            _this.file.resolveLocalFilesystemUrl(imageData).then(function (fileEntry) {
                return new Promise(function (resolve, reject) {
                    fileEntry.file(function (meta) { return resolve(meta); }, function (error) { return reject(error); });
    ...
    EditMedicationPage.prototype.deleteImage = function () {
        var _this = this;
        var delete_detail = { "index": this.spliceIndexArray, "id": this.edit_details["id"] };
        this.service.deleteImage(delete_detail).subscribe(function (res) {
            console.log(res);
            if (_this.fileuri.length > 0) {
                var event_id = _this.edit_details['id'];
    ...
    EditMedicationPage.prototype.removeImg = function (index, image, originalArray) {
        var result = originalArray.some(function (el) { return el.uri === image.uri; });
        if (result == true) {
            var index1 = this.originalArray.findIndex(function (p) { return p.uri == image.uri; });
            this.spliceIndexArray.push(index1);
            this.edit_all_image.splice(index, 1);
        }
        else {
            this.edit_all_image.splice(index, 1);
            var fileResult = this.fileuri.some(function (el) { return el.uri === image.uri; });
            if (fileResult == true) {
                var index1 = this.fileuri.findIndex(function (p) { return p.uri == image.uri; });
...
var EditVitalsAlertPage = /** @class */ (function () {
    function EditVitalsAlertPage(toast, localNotifications, alertController, toastController, datepipe, service, fb, route, router, statusBar) {
        var _this = this;
        this.toast = toast;
        this.localNotifications = localNotifications;
        this.alertController = alertController;
