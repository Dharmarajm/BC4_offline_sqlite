...
var EditProfilePage = /** @class */ (function () {
    function EditProfilePage(toast, actionSheetController, fb, sanitizer, route, file, transfer, camera, imagePicker, webview, crop, serv, navParams, modalController, toastController, networkProvider, database) {
    ...
    EditProfilePage.prototype.sample = function (data) {
...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(toast, toastController, localNotifications, file, FilePath, fileChooser, statusBar, modalController, sanitizer, serv, actionSheetController, router, alertController, clipboard, database, databaseSummary, networkProvider, webview) {
        this.toast = toast;
        this.toastController = toastController;
