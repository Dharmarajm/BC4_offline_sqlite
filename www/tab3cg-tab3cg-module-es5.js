...
var EditCGProfilePage = /** @class */ (function () {
    function EditCGProfilePage(toast, actionSheetController, fb, sanitizer, route, file, transfer, camera, imagePicker, webview, crop, serv, navParams, modalController, toastController) {
    ...
    EditCGProfilePage.prototype.sample = function () {
        var _this = this;
...
var Tab3cPage = /** @class */ (function () {
    function Tab3cPage(statusBar, modalController, sanitizer, serv, actionSheetController, router, alertController, clipboard, file, FilePath, fileChooser) {
