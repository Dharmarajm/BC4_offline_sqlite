...
let AnalyticsPage = class AnalyticsPage {
    constructor(fb, datepipe, modalController, service, route, router, statusBar) {
        this.fb = fb;
        this.datepipe = datepipe;
...
let FilterPage = class FilterPage {
    constructor(datepipe, fb, modalController, service, statusBar) {
        this.datepipe = datepipe;
        this.fb = fb;
        this.modalController = modalController;
        this.service = service;
...
let VitalReadingPage = class VitalReadingPage {
    constructor(modalCtrl, toast, datepipe, service, route, router, toastController, alertController, statusBar) {
