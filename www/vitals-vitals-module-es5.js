...
var AddVitalsPage = /** @class */ (function () {
    function AddVitalsPage(toast, alertController, toastController, datepipe, service, fb, route, router, statusBar) {
        this.toast = toast;
    ...
    AddVitalsPage.prototype.valueSet = function (val) {
        ...
        if (selectVital == "Blood Glucose" || selectVital == "Cholesterol") {
            this.service.vitalFoodTime2().subscribe(function (res) {
            ...
            this.service.vitalFoodTime1().subscribe(function (res) {
                _this.food_options = res['enum_masters'];
                console.log(_this.food_options);
            });
        }
        else {
                        ...
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        cssClass: 'secondary',
                                        handler: function () {
                                            _this.service.vitalCommonPost(_this.vital_post).subscribe(function (res) {
                                                _this.Progress = false;
                                                _this.vital_details = res;
                                                _this.presentAlert();
                                            });
                                        }
                                    }
...
var AnalyticsPage = /** @class */ (function () {
    function AnalyticsPage(fb, datepipe, modalController, service, route, router, statusBar) {
        this.fb = fb;
        this.datepipe = datepipe;
    ...
    AnalyticsPage.prototype.ionViewWillEnter = function () {
        ...
        this.service.vitalEventListNew(this.user_id).subscribe(function (res) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            if (data['data'] != undefined) {
                                ...
                                _this.service.vitalfilter(_this.user_id, data['data']).subscribe(function (res) {
                                    _this.parseResponse(res);
                                });
                            }
                        });
    ...
    AnalyticsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["DatePipe"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _self_common_service_settings_settings_service__WEBPACK_IMPORTED_MODULE_3__["settingsService"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_8__["StatusBar"]])
    ], AnalyticsPage);
...
var FilterPage = /** @class */ (function () {
    function FilterPage(datepipe, fb, modalController, service, statusBar) {
        this.datepipe = datepipe;
        this.fb = fb;
        this.modalController = modalController;
        this.service = service;
    ...
    FilterPage.prototype.ngOnInit = function () {
        ...
        this.filter = this.fb.group({
            'from_date': [this.todaydate, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]],
            'end_date': [this.todaydate, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]],
            'event_name': ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]]
        });
        this.user_id = localStorage.getItem("user_id");
        this.service.vitalEventListNew(this.user_id).subscribe(function (res) {
            _this.listvalues = res;
            _this.list_keys = Object.keys(_this.listvalues);
        });
    };
    ...
    FilterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_5__["DatePipe"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _self_common_service_settings_settings_service__WEBPACK_IMPORTED_MODULE_3__["settingsService"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"]])
    ], FilterPage);
    return FilterPage;
}());
...
var VitalReadingPage = /** @class */ (function () {
    function VitalReadingPage(modalCtrl, toast, datepipe, service, route, router, toastController, alertController, statusBar) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            _this.service.reading_history(_this.event_name, _this.user_id, _this.page, _this.count).subscribe(function (res) {
                _this.previous_data = res['events'];
                _this.delete_content = _this.previous_data['event_name'];
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.service.filterReading(this.event_name, this.user_id, this.page, this.count, from_date, end_date).subscribe(function (res) {
                            var filter = res['events'];
                            _this.groupBy(filter);
                        });
                        return [2 /*return*/];
                }
            });
    ...
    VitalReadingPage.prototype.scroll = function (event) {
        var _this = this;
        setTimeout(function () {
            _this.page += 1;
            _this.service.reading_history(_this.event_name, _this.user_id, _this.page, _this.count).subscribe(function (res) {
                var data = res['events'];
                var concat = _this.previous_data.concat(data);
                _this.previous_data = concat;
                var records = _this.previous_data.map(function (item) { return ({
                    id: item.id,
                    description: item.description,
                    event_name: item.event_name,
                    event_category: item.event_category,
                ...
                _this.vital_scroll = value;
                _this.vital_reading = _this.vital_scroll;
                            ...
                            buttons: [
                                {
                                    text: 'Confirm',
                                    handler: function () {
                                        _this.service.commonDeleteEvent(id).subscribe(function (res) {
...
var VitalsPage = /** @class */ (function () {
    function VitalsPage(datepipe, service, route, router, alertController, statusBar) {
        this.datepipe = datepipe;
        this.service = service;
        this.route = route;
        this.router = router;
    ...
    VitalsPage.prototype.ionViewWillEnter = function () {
        ...
        this.status = true;
        this.user_id = localStorage.getItem("user_id");
        this.service.vitalEventList(this.user_id).subscribe(function (res) {
            _this.status = false;
            _this.vital_details = res;
            _this.vital_keys = Object.keys(_this.vital_details);
        });
    };
