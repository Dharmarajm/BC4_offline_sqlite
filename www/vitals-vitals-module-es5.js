...
var VitalReadingPage = /** @class */ (function () {
    ...
    VitalReadingPage.prototype.ionViewWillEnter = function () {
        ...
        this.service.filterReading(this.event_name, this.user_id, this.page, this.count, this.from_date1, this.end_date1).subscribe(function (res) {
            _this.previous_data = res['events'];
            _this.groupBy(_this.previous_data);
            console.log(_this.previous_data);
        });
    };
    ...
    VitalReadingPage.prototype.loadData = function (scroll) {
        ...
        setTimeout(function () {
            _this.page += 1;
            _this.service.filterReading(_this.event_name, _this.user_id, _this.page, _this.count, _this.from_date1, _this.end_date1).subscribe(function (res) {
...
var VitalsPage = /** @class */ (function () {
    ...
    VitalsPage.prototype.ionViewWillEnter = function () {
        ...
        // })
        this.databaseSummary.getVitalEvents('vital', 'New', 7).then(function (res) {
            console.log(res);
            _this.status = false;
