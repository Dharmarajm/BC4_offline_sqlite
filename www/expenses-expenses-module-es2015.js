...
let addExpensesPage = class addExpensesPage {
    constructor(alertController, toast, toastController, router, event, fb, statusBar) {
    ...
    Change(c) {
        ...
        if (this.Addmore != "Others") {
            ...
            this.submitted = false;
            const validators = [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required];
...
addExpensesPage.ctorParameters = () => [
...
let ExpensesPage = class ExpensesPage {
    constructor(expense, datepipe, statusBar) {
...
let FiltersPage = class FiltersPage {
    constructor(datepipe, modalController, fb, serv, router, statusBar) {
        this.datepipe = datepipe;
...
let viewAnalyticsPage = class viewAnalyticsPage {
    constructor(modalController, service, datepipe, statusBar) {
        this.modalController = modalController;
...
viewAnalyticsPage.ctorParameters = () => [
...
let viewSummaryPage = class viewSummaryPage {
    constructor(toast, modalCtrl, toastController, alertController, expen_view, statusBar) {
        this.toast = toast;
...
viewSummaryPage.ctorParameters = () => [
