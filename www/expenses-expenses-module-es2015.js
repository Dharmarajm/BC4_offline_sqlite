...
let addExpensesPage = class addExpensesPage {
    constructor(alertController, toast, toastController, router, event, fb, statusBar, database, databaseSummary) {
...
let viewSummaryPage = class viewSummaryPage {
    constructor(toast, modalCtrl, toastController, alertController, expen_view, statusBar, database) {
        this.toast = toast;
