...
@Component({
    selector: 'app-common-self-care-play',
    templateUrl: 'common-self-care-play.page.html',
    styleUrls: ['./common-self-care-play.scss'],
 })
 export class commonSelfCarePlay implements OnInit {
